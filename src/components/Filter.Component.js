...
import { SHOW_ALL, SHOW_COMPLETED, SHOW_ACTIVE } from "../redux/constants";
    ...
    return (
      <div className="container align-right">
        <div className="bordered-box filter-block">
          ...
          <span
            className={["active-elem",
              active === SHOW_ACTIVE ? "selected" : ""].join(" ")}
          ...
          <span
            className={["active-elem",
              active === SHOW_COMPLETED ? "selected" : ""].join(" ")}
